...
export default function CardWrapper() {
  ...
  const config =
    "Customize your own groupings, airline class mapping and more.";
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      <CardComponent
        ...
        type="basic"
        path="/home_account/reportmanager"
      />
      <CardComponent
        title="Report Design"
        value={report_design}
        type="basic"
        path="/home_account/reportdesign/create"
      />
      <CardComponent
        title="Loading Status"
        value={status_loading}
        type="basic"
        path="/home_account/loadingstatus"
      />
      <CardComponent
        title="Analytics"
        value={analytics}
        type="basic"
        path="/home_account/analytics"
      />
      <CardComponent
        title="Configuration"
        value={config}
        type="basic"
        path="/home_account/configuration"
      />
      <CardComponent
        title="Profile"
        value={profile}
        type="basic"
        path="/home_user/profile"
      />
    </div>
  );
}
