...
import SubGroups from "@/app/home_account/configuration/agencygrouping/ui/SubGroups";
import AgencyGroups from "@/app/home_account/configuration/agencygrouping/ui/AgencyGroups";
import AgencyCodes from "@/app/home_account/configuration/agencygrouping/ui/AgencyCodes";
import AddGroupDialog from "@/app/home_account/configuration/agencygrouping/ui/AddGroupDialog";
import AddSubGroupDialog from "@/app/home_account/configuration/agencygrouping/ui/AddSubGroupDialog";
import DeleteConfirmationDialog from "@/app/home_account/configuration/agencygrouping/ui/DeleteConfirmationDialog";
...
export default function AgencyGroupingPage() {
  ...
  const [initialAgencyCodes, setinitialAgencyCodes] = useState<{
    [key: string]: string;
  }>({});
  ...
  useEffect(() => {
    ...
    fetch("/api/configuration/agencyGrouping/initialAgencyCodesWithAssignments")
      ...
      .catch((error) =>
        console.error(
          "Error fetching initialAgencyCodesWithAssignments:",
          error,
        ),
      );
    ...
    fetch("/api/configuration/agencyGrouping/initialAgencyCodes")
      ...
      .catch((error) =>
        console.error("Error fetching initialAgencyCodes:", error),
      )
