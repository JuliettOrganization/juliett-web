...
import SubGroups from "@/app/home_account/configuration/airlinegrouping/ui/SubGroups";
import AirlineGroups from "@/app/home_account/configuration/airlinegrouping/ui/AirlineGroups";
import AirlineCodes from "@/app/home_account/configuration/airlinegrouping/ui/AirlineCodes";
import AddGroupDialog from "@/app/home_account/configuration/airlinegrouping/ui/AddGroupDialog";
import AddSubGroupDialog from "@/app/home_account/configuration/airlinegrouping/ui/AddSubGroupDialog";
import DeleteConfirmationDialog from "@/app/home_account/configuration/airlinegrouping/ui/DeleteConfirmationDialog";
...
export default function AirlineGroupingPage() {
  ...
  const [initialAirlineCodes, setinitialAirlineCodes] = useState<{
    [key: string]: string;
  }>({});
  ...
  useEffect(() => {
    ...
    fetch(
      "/api/configuration/airlineGrouping/initialAirlineCodesWithAssignments",
    )
      .then((response) => response.json())
      .then((data) => setAirlineCodes(data))
      .catch((error) =>
        console.error(
          "Error fetching initialAirlineCodesWithAssignments:",
          error,
        ),
      )
      .finally(() => setLoading(false));
    ...
    fetch("/api/configuration/airlineGrouping/initialAirlineCodes")
      ...
      .catch((error) =>
        console.error("Error fetching initialAirlineCodes:", error),
      )
      .finally(() => setLoading(false));
  }, []);
