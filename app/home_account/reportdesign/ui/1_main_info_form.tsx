...
import TagInput from "./1_TagInput";
    ...
    <div className="p-4">
      <div className="rounded-md border-none bg-white p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6 mt-6">
          ...
          <div className="mb-4">
            <label
              htmlFor="date_concept"
              className="mb-2 block text-sm font-medium w-40"
            >
              Date Concept
            </label>
            <div className="relative">
              ...
              >
                <option value="Issue Date" className="bg-white text-black">
                  Issue Date
                </option>
                <option value="Travel Date" className="bg-white text-black">
                  Travel Date
                </option>
                <option value="Reporting Date" className="bg-white text-black">
                  Reporting Date
                </option>
              </select>
            </div>
