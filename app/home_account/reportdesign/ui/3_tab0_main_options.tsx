...
import CheckBoxTransactionType from "@/app/home_account/reportdesign/ui/3_tab0_transaction_type_check-box";
import CheckBoxAmount from "@/app/home_account/reportdesign/ui/3_tab0_amounts_check-box";
  ...
  return (
    <div className="space-y-2 p-4 rounded-lg">
      <div className="rounded-md border-none bg-white ">
        <div className="flex flex-row rounded-md pr-4 justify-start text-xl font-bold">
          Main Options
        </div>
