...
async function processReport(reportData: any, reportId: string) {
  try {
    ...
    const reportRows = [
      ...
      {
        field: "Fields",
        value: reportData.fields ? reportData.fields.join(", ") : "",
      },
      { field: "Transaction Type", value: reportData.transactionType },
      {
        field: "Amounts",
        value: reportData.amounts ? reportData.amounts.join(", ") : "",
      },
      {
        field: "Selected Grouping Values Agency",
        value: parseAndJoin(reportData.selectedGroupingValuesAgency),
      },
      {
        field: "Selected Grouping Agency",
        value: parseAndJoin(reportData.selectedGroupingAgency),
      },
      {
        field: "Selected Grouping Values Issuing",
        value: parseAndJoin(reportData.selectedGroupingValuesIssuing),
      },
      {
        field: "Selected Grouping Issuing",
        value: parseAndJoin(reportData.selectedGroupingIssuing),
      },
      {
        field: "Selected Grouping Values Marketing",
        value: parseAndJoin(reportData.selectedGroupingValuesMarketing),
      },
      {
        field: "Selected Grouping Marketing",
        value: parseAndJoin(reportData.selectedGroupingMarketing),
      },
      {
        field: "Selected Grouping Values Operating",
        value: parseAndJoin(reportData.selectedGroupingValuesOperating),
      },
      {
        field: "Selected Grouping Operating",
        value: parseAndJoin(reportData.selectedGroupingOperating),
      },
      {
        field: "Selected Grouping Values Geo From",
        value: parseAndJoin(reportData.selectedGroupingValuesGeoFrom),
      },
      {
        field: "Selected Grouping Geo From",
        value: parseAndJoin(reportData.selectedGroupingGeoFrom),
      },
      {
        field: "Selected Grouping Values Geo To",
        value: parseAndJoin(reportData.selectedGroupingValuesGeoTo),
      },
      {
        field: "Selected Grouping Geo To",
        value: parseAndJoin(reportData.selectedGroupingGeoTo),
      },
      ...
      {
        field: "Is SQL Active",
        value: reportData.isCustomSqlActive ? "Yes" : "No",
      },
    ];
