...
export default function UserGuidePage() {
  const [downloadLink] = useState('/api/docs/download-userguide'); // Path to the API route

  return (
    <main className="flex h-[80vh] items-center rounded-lg justify-center bg-gray-100">
