...
export default function PDFDownloader() {
  ...
  return ( <main className="flex-col h-[80vh] items-center rounded-lg justify-center bg-gray-300">
         ...
         <div className="max-w-2xl mx-auto mt-10 p-10 rounded-xl bg-white shadow-lg">
            ...
            <Button onClick={handleDownload} className="inline-flex items-center px-6 py-3 bg-blue-600 text-white text-lg font-medium rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
