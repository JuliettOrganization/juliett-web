...
export default function SupportPage() {
  return (
    <main
      className="fixed top-20 left-0 h-full w-full z-auto items-center justify-center min-h-screen bg-gray-100 bg-cover bg-center"
    ...
    >
      <div className="flex w-64 left-0 m-4 rounded-full justify-start p-3 shadow bg-gray-200 hover:bg-gray-300 z-10">
        <Link
          href="/home_user"
          className="flex items-center space-x-2 text-black-600"
        >
