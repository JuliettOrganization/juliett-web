...
import SubGroups from '@/app/ui/home_account/configuration/geogrouping/SubGroups';
import GeoGroups from '@/app/ui/home_account/configuration/geogrouping/GeoGroups';
import GeoCodes from '@/app/ui/home_account/configuration/geogrouping/GeoCodes';
import AddGroupDialog from '@/app/ui/home_account/configuration/geogrouping/AddGroupDialog';
import AddSubGroupDialog from '@/app/ui/home_account/configuration/geogrouping/AddSubGroupDialog';
...
export default function GeoGroupingPage() {
  ...
  const [geoCodes, setGeoCodes] = useState<{ [key: string]: { [key: string]: string } }>({});
  ...
  useEffect(() => {
    ...
    fetch('/api/configuration/geoGrouping/subGroups')
      ...
      .finally(() => setLoading(false));
        ...
        .catch((error) => console.error('Error fetching initialGeoCodesWithAssignments:', error))
        .finally(() => setLoading(false));
